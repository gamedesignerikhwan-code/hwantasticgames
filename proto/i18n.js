    ...
    const ko = {
        ...
        modals: {
            ...
            starWindowModal: {
                ...
                headings: ['🔭 게임 소개', '🧩 핵심 메커니즘', '🌐 온라인 플레이테스트'],
                paragraphs: [
                    '<strong>Star Window (천문대의 밤)</strong>은 2~4명이 즐기는 천체 타일 배치·공간 점수 보드게임입니다. 10일 밤 동안 천문대장들은 개인 밤하늘 지도를 넓히고, 렌즈로 별·행성·혜성·성운·은하의 가장 가치 있는 배열을 포착합니다.',
