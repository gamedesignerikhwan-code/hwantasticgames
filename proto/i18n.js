(function () {
    ...
    const ko = {
        ...
        cards: {
            ...
            'card-my-little-hutch': {
                subtitle: '타일 드래프팅 & 목동 엔진 보드게임',
                desc: '5×5 오두막 농장에서 펼쳐지는 2중 퍼즐 & 일꾼 드래프팅 보드게임! 공용 마켓에서 도미노와 싱글 타일을 가져와 줄을 완성해 높은 빙고 보너스를 선점하고, 동물들이 모인 곳에 목동을 배치해 폭발적인 점수를 수확하세요.',
                meta: ['2–4명', '30–45분', '타일 드래프트', '2중 퍼즐']
            }
        }
    };
